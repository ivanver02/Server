...
class VitPoseDetector:
    ...
    def __init__(self):
        ...
        self.config = mmpose_config.vitpose
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info("VitPose detector initialized successfully")
            return True
            
        except Exception as e:
            logger.error(f"Error initializing VitPose detector: {e}")
            return False
    ...
    def process_chunk(self, video_path: Path, patient_id: str, session_id: str, 
        ...
        try:
            ...
            logger.info(f"VitPose processing completed for chunk {chunk_id}")
            return True
    ...
    def _create_annotated_video_directory(self, patient_id: str, session_id: str, 
        ...
        annotated_dir = (data_config.annotated_videos_dir / "vitpose" / 
