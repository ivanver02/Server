...
class HRNetDetector(BasePoseDetector):
    """
    Detector de pose utilizando HRNet
    """
    ...
    def __init__(self):
        ...
        self.keypoints_names = [
            ...
            # Foot keypoints (6) - Son los que usamos ahora mismo en el ensemble junto con los de COCO
            "left_big_toe", "left_small_toe", "left_heel",
            "right_big_toe", "right_small_toe", "right_heel",

            # Face keypoints (68) - El modelo los devuelve, pero no nos interesa
            ...
            # Left hand keypoints (21) -  El modelo los devuelve, pero no nos interesa
            ...
            # Right hand keypoints (21) -  El modelo los devuelve, pero no nos interesa
