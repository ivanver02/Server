...
class HRNetDetector:
    ...
    def __init__(self):
        ...
        self.config = mmpose_config.hrnet
        self.is_initialized = False
        
    def initialize(self) -> bool:
        """
        Inicializar el detector HRNet
        """
        try:
            ...
            logger.info("HRNet detector initialized successfully")
            return True
            
        except Exception as e:
            logger.error(f"Error initializing HRNet detector: {e}")
            return False
    ...
    def process_chunk(self, video_path: Path, patient_id: str, session_id: str, 
        ...
        try:
            ...
            logger.info(f"HRNet processing completed for chunk {chunk_id}")
            return True
    ...
    def _create_annotated_video_directory(self, patient_id: str, session_id: str, 
        ...
        annotated_dir = (data_config.annotated_videos_dir / "hrnet" / 
