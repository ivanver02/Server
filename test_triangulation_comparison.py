...
from backend.processing.reconstruction.triangulation_svd import triangulate_frame_svd
# from backend.processing.reconstruction.triangulation_bundle_adjustment import refine_frame_bundle_adjustment
from backend.processing.reconstruction.bundle_adjustment import bundle_adjustment
    ...
    try:
        ...
        try:
            if results["SVD_Triangulation"] is not None:
                ...
                points_3d_ba = points_3d_svd_unscaled  # Usar SVD directamente hasta que se implemente BA
